...
async function robot(){
        ...
        async function waitForGoogleCallback(webServer){
            return new Promise((resolve,reject) => {
                ...
                webServer.app.get('oauth2callback', (req, res) => {
                    ...
                    res.sent('<h1>Thank you!!<h1><p> You may close this tab now.<p>')
                    resolve(authCode)
                })
    ...
    async function uploadVideo(content){
        const videoFilePath = `./results/${content.searchTerm}.mov`
        ...
        console.log(`> Video available at: https://youtu.be/${youtube.data.id}`)
